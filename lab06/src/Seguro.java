...
public abstract class Seguro {
    ...
    public boolean gerarSinistro() throws ParseException {
        ...
        if (resp.equals("1")) {
            ...
            Sinistro.adicionarSinistro(novo);
    ...
    public String seguroCsv() {
        return "\n" + id + "," + sdf.format(dataInicio) + "," + sdf.format(dataFim) + "," +
                seguradora.getNome() + "," + sinistrosCsv() + "," + condutoresCsv() + "," + valorMensal + ",";
    }
