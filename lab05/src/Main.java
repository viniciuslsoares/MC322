...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Seguradora seguradora = new Seguradora("12.528.708/0001-07", "Porto Seguro", "(19)99999-9999", "portoseguro@gmail.com", "Taquaral");
        Seguradora.adicionaSeguradora(seguradora);
        Seguradora seguradora2 = new Seguradora("00.394.460/0058-87", "Tokyo", "(19)3869-6871", "tokyo@gmail.com", "Campinas");
        ...
        /*         NOTE
        Os dois seguros foram instanciados manualmente (fora do método específico) pois esse método pede 
        interação através do terminal. Esses métodos seguem na main. 
        Essa instanciação também é necessária para gerar o sinistro através do método apropriado        */
        ...
        SeguroPF seguro1 = new SeguroPF(hoje, dataFim, seguradora, lista_sinistro01, lista_condutores01, veiculo1, cliente1);
        SeguroPJ seguro2 = new SeguroPJ(hoje, dataFim, seguradora, lista_sinistro02, lista_condutores02, frota, cliente4);
